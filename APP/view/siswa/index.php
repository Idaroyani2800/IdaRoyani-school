        ...
        <div class="row">
          ...
          <div class="row mb-3">
              <div class="col-lg-6">
                ...
                <input type="text" class="form-control" placeholder="cari data siswa.." name="keyword" id="keyword"
                    ...
                    <?php foreach ($data['siswa'] as $siswa) : ?>
                      <tr>
                        ...
                        <td><?= $siswa['nama']; ?></td>
                         ...
                         <td><a href="<?= BASE_URL; ?>/siswa/hapus/<?= $siswa['id']; ?>"
                         class="badge badge-danger " onclick="return confirm('yakin?');">hapus</a>

                         <a href="<?= BASE_URL; ?>/siswa/ubah/<?= $siswa['id']; ?>"
                         class="badge badge-success  tampilModalUbah" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-id="<?= $siswa['id']; ?>">ubah</a>
